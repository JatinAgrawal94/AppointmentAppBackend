...
namespace AppointmentAppBackend
{
    public class JwtHandler
    {
        ...
        public JwtHandler(IConfiguration configuration, UserManager<HospitalUser> userManager)
        {
            _configuration = configuration;
            _userManager = userManager;
        }

        public async Task<JwtSecurityToken> GetTokenAsync(HospitalUser user) =>
            new(
        ...
        private async Task<List<Claim>> GetClaimsAsync(HospitalUser user)
        {
